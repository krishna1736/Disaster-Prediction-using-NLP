...
$sql4="SELECT json_build_object('type', 'FeatureCollection','features', json_agg(ST_AsGeoJSON(t.*)::json))FROM ( select id,name ,coordinate as geom,tweet from training_table) as t(id,name,geom,tweet);";
